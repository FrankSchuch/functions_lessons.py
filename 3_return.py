# Return Practice #1
# Create a function called power that takes two numeric values as paramaters. It must return the number that results from solving a power, using the first number as the base, and the second as the exponent
